...
public partial class ListaConsultarEmpleadosContainer : VBoxContainer
{
        ...
        switch (responseCode)
        {
            case 200:
                ...
                for (int i = 0; i < responseArray.Count; i++)
                {
                    ...
                    PackedScene _empleadoItemContainer = ResourceLoader.Load<PackedScene>(
                        "res://Scenes/AdministrarEmpleado/RegistrarEmpleado/Components/empleado_item_container.tscn"
                    );
                    EmpleadoItemContainer empleadoItemContainer = (EmpleadoItemContainer)
                        _empleadoItemContainer.Instantiate();

                    AddChild(empleadoItemContainer);
                    empleadoItemContainer.Employee = employee;
                }
