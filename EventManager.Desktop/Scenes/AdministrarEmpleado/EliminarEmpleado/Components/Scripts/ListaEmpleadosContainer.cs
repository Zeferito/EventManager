        ...
        switch (responseCode)
        {
            case 200:
                ...
                for (int i = 0; i < responseArray.Count; i++)
                {
                    ...
                    PackedScene _borrarEmpleadoComponent = ResourceLoader.Load<PackedScene>(
                        "res://Scenes/AdministrarEmpleado/EliminarEmpleado/Components/BorrarEmpleadoComponent.tscn"
                    );
                    BorrarEmpleadoComponent borrarEmpleadoComponent = (BorrarEmpleadoComponent)
                        _borrarEmpleadoComponent.Instantiate();

                    AddChild(borrarEmpleadoComponent);
                    borrarEmpleadoComponent.Client = employee;
                }
